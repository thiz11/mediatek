...
OUTDIR=$ANDROID_TOP/vendor/$VENDOR/$DEVICE
MAKEFILE=$OUTDIR/$DEVICE-vendor-blobs.mk

(cat << EOF) > $ANDROID_TOP/vendor/$VENDOR/$DEVICE/$DEVICE-vendor.mk
...
(cat << EOF) > $ANDROID_TOP/vendor/$VENDOR/$DEVICE/BoardConfigVendor.mk
# Copyright (C) 2014 The Android Open Source Project
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
...
LINEEND=" \\"
COUNT=`cat $PROG/proprietary-files.txt | grep -v ^# | grep -v ^$ | wc -l | awk {'print $1'}`
...
(cat << EOF) > $ANDROID_TOP/vendor/$VENDOR/$DEVICE/proprietary/lib/Android.mk
