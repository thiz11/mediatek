...
#CUSTOM_BUILD_VERNO=S9320KK_MP_00_01
#INTERNAL_BUILD_VERNO=S9320KK_MP_00_01
...
CUSTOM_HAL_IMGSENSOR = imx135_mipi_raw imx136_mipi_raw imx179_mipi_raw imx178_mipi_raw ov16825_mipi_raw ov16826_mipi_raw
...
CUSTOM_HAL_MAIN_IMGSENSOR = imx135_mipi_raw imx136_mipi_raw ov16825_mipi_raw ov16826_mipi_raw

# lens driver config for main camera
CUSTOM_HAL_MAIN_LENS = fm50af bu6424af
...
CUSTOM_KERNEL_IMGSENSOR = imx135_mipi_raw imx136_mipi_raw imx179_mipi_raw imx178_mipi_raw ov16825_mipi_raw ov16826_mipi_raw

# key pad driver to report key event
CUSTOM_KERNEL_KPD=tpd
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx135_mipi_raw imx136_mipi_raw ov16825_mipi_raw ov16826_mipi_raw

# lens driver config for main camera
CUSTOM_KERNEL_MAIN_LENS = fm50af bu6424af
...
CUSTOM_KERNEL_SUB_IMGSENSOR = imx179_mipi_raw imx178_mipi_raw

# lens driver config for video telephony camera
CUSTOM_KERNEL_SUB_LENS=dummy_lens

# touch driver  need to report correct touch axes
CUSTOM_KERNEL_TOUCHPANEL = synaptics  ft5x06tb
...
CUSTOM_LK_LCM=r63311_fhd_dsi_vdo_sharp nt35590_hd720_dsi_vdo_truly nt35590_hd720_dsi_cmd_auo
...
# enable/disable external audio codec support
...
# This feature Option is used for projects which using more than one ALSPS sensors, more than one ALSPS drivers can be builded in to project and be auto detected by adding this option to the project.
...
# Device register
MTK_DEVREG_APP=yes
MTK_DFO_RESOLUTION_SUPPORT=yes
MTK_DFO_TEST1=yes
MTK_DFO_TEST2=2
...
# enable/disable 24bit audio feature support
...
MTK_PARTITION_TABLE_PLAIN_TEXT=yes
MTK_PASSPOINT_R1_SUPPORT=yes
MTK_PCB_BATTERY_SENSOR=no
MTK_PERFSERVICE_SUPPORT=yes

# This option is for mtk in house permission control for CTA requirement test feature.
...
MTK_PRODUCT_AAPT_CONFIG=hdpi xhdpi xxhdpi -sw720dp -sw600dp
...
MTK_RELEASE_PACKAGE=rel_customer_basic rel_customer_platform_mt6592
...
# This is used to unlock the device to allow customized android load to be downloaded on phone through.
...
RESOURCE_OVERLAY_SUPPORT=ct_hd720 hdpi xhdpi LCA_rom LCA_ram
...
# CUSTOM_MODEM=tinno92_wet_kk_hspa_s9320kk
...
CUSTOM_KERNEL_LCM=r63311_fhd_dsi_vdo_sharp nt35590_hd720_dsi_vdo_truly nt35590_hd720_dsi_cmd_auo

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=r63311_fhd_dsi_vdo_sharp nt35590_hd720_dsi_vdo_truly nt35590_hd720_dsi_cmd_auo
...
MTK_PRODUCT_LOCALES=en_US es_ES zh_CN zh_TW ru_RU pt_BR fr_FR de_DE tr_TR it_IT in_ID ms_MY vi_VN ar_EG  th_TH  pt_PT   nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ iw_IL my_MM km_KH ko_KR pl_PL es_US bg_BG hr_HR lv_LV lt_LT sk_SK uk_UA de_AT da_DK fi_FI nb_NO sv_SE en_GB ldpi xhdpi hdpi mdpi xxhdpi
...
#CREATE_PROJECT_INFO=201402219230
MTK_BUILD_VERNO = ALPS.KK1.MP1.V2.10
#project name
#add yaohua.li
CUSTOM_KERNEL_HALL=ak8789
#endif
TINNO_ANDROID_S9320AE=yes
#boot mode ui  font size
TINNO_LK_BIG_FONT=yes
SUPPORT_TINNO_BATTERY_COMPENSATE=yes
SUPPORT_TINNO_BATTERY_DEBUG=no
TINNO_CALIBRATION_DOD=yes
SUPPORT_TINNO_BQ27541=yes
SUPPORT_TINNO_LCD_TEST=no
TINNO_GESTURE_SUPPORT=yes
#define this for Tinno UI Camera
TINNO_UI_CAMERA_SUPPORT=yes
#define this for Tinno UI Gallery
TINNO_UI_GALLERY_SUPPORT=yes
TINNO_UI_ACCESS_CAMERA=yes

#For WIKO start
CUSTOM_WIKO_VERSION =yes
CUSTOM_BUILD_VERNO= WIKO HIGHWAY Version 8
INTERNAL_BUILD_VERNO = S9320KK_MP_FR_WIK_09_11
CUSTOM_BUILD_DE_VERNO = WIKO HIGHWAY Version 11
MTK_MASS_STORAGE=no
MTK_PHONE_NUMBER_GEODESCRIPTION=no
BUILD_GMS=yes
TINNO_ECONOMICMODE_SUPPORT = yes
TINNO_SLIPCOVER_MODE_SUPPORT=yes
#lion add for subdisplay
TINNO_SUBDISPLAYINFO_APP=yes
TINNO_ANDROID_S9320AE_TP_NVRAM=yes
MTK_OOBE_APP=no
#For WIKO end
