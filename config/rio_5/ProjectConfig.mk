...
CUSTOM_HAL_IMGSENSOR=ov5648qt_mipi_raw ov5648st_mipi_raw gc0313_mipi_yuv

# = CUSTOM_HAL_MAIN_LENS +CUSTOM_HAL_MAIN_BACKUP_LENS + CUSTOM_HAL_SUB_LENS + CUSTOM_HAL_SUB_BACKUP_LENS
CUSTOM_HAL_LENS=bu6424qtaf bu6424staf dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR=
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR=ov5648st_mipi_raw
...
CUSTOM_HAL_SUB_IMGSENSOR=gc0313_mipi_yuv
...
# Back cover driver designed only for RIO5
CUSTOM_KERNEL_BACKCOVER=
...
CUSTOM_KERNEL_IMGSENSOR=ov5648qt_mipi_raw ov5648st_mipi_raw gc0313_mipi_yuv
...
CUSTOM_KERNEL_SUB_IMGSENSOR=gc0313_mipi_yuv
...
CUSTOM_MODEM=jrdsh82_90lw_kk[lfwg]
...
CUSTOM_KERNEL_LCM=nt35517_qhd_dsi_vdo hx8389b_byd_qhd_dsi_vdo

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=nt35517_qhd_dsi_vdo hx8389b_byd_qhd_dsi_vdo
...
MTK_BUILD_VERNO = ALPS.KK1.MP2.V1
#Added by jrd.lipeng for audio parameters customization(PR408943)
JRD_AUDIO_PARAMS_CUST_M = yes
#Added by jrd.hongyu.chu for over current issue
JRD_RIO5_OVER_CURRENT = yes
# [JRD.Blur] {{{
JRD_BLUR_SUPPORT=no
# [JRD.Blur] }}}
