		...
		case GSENSOR_IOCTL_SET_CALI:
			...
			else
			{
				...
				cali[BMA222E_AXIS_Z] = sensor_data.z * obj->reso->sensitivity / GRAVITY_EARTH_1000;		
					...
					/*if(cali[BMA222E_AXIS_X] > 0)
						cali[BMA222E_AXIS_X] +=1;
					if(cali[BMA222E_AXIS_X] < 0)
						cali[BMA222E_AXIS_X] -=1;
					if(cali[BMA222E_AXIS_Y] > 0)
						cali[BMA222E_AXIS_Y] +=1;
					if(cali[BMA222E_AXIS_Y] < 0)
						cali[BMA222E_AXIS_Y] -=1;
					if(cali[BMA222E_AXIS_Z] > 0)
						cali[BMA222E_AXIS_Z] +=1;
					if(cali[BMA222E_AXIS_Z] < 0)
						cali[BMA222E_AXIS_Z] -=1;*/
...
{
	GSE_FUN();
      i2c_register_board_info(2, &i2c_bma222E, 1);
