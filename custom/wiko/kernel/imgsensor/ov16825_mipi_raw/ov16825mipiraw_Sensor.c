...
#if defined(OV16825_USE_LSC_OTP)
// For HW
...
static void OV16825_global_setting(void)
{
	kal_uint16 BLC_Reg = 0;
	SENSORDB("OV16825_Sensor_Init enter :\n ");	
	/*
	...
	*/
    ...
    SENSORDB("OV16825_Sensor_Init exit :\n ");
}

//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
static void OV16825__1224_30fps_Mclk24M_setting(void)
{
/*
	//OV16825_1632*1224_setting
	//4lanes: 648Mbps/lane_30fps
    H Total: 0x0e18 = 3608
    V Total: 0x07cc = 1996
	//;;;;;;;;;;;;;Any modify please inform to OV FAE;;;;;;;;;;;;;;;	  
*/
	SENSORDB("OV16825_1632_1224_30fps_Mclk24M_setting start \n");
//if(Flag == 1)
	//Flag = 0;
//else
    ...
    OV16825_write_cmos_sensor(0x3011, 0x21);// 2 lane MIPI
    OV16825_write_cmos_sensor(0x3015, 0xca);// 2 lane enable
    
	OV16825_write_cmos_sensor(0x3090, 0x03);// PLL2 prediv 
    OV16825_write_cmos_sensor(0x3091, 0x22);// PLL2 multiplier
    OV16825_write_cmos_sensor(0x3092, 0x00);
	OV16825_write_cmos_sensor(0x3093, 0x02);
	
	SENSORDB("OV16825_1632_1224_30fps_Mclk24M_setting 2 lane start \n");
#else //default use 4 lane
    OV16825_write_cmos_sensor(0x3011, 0x41);//2 
    OV16825_write_cmos_sensor(0x3015, 0x0a);// MIPI mode,  ca
    
	OV16825_write_cmos_sensor(0x3090, 0x02);//216MHz SCLK 
    OV16825_write_cmos_sensor(0x3091, 0x12);
	OV16825_write_cmos_sensor(0x3092, 0x00);
	OV16825_write_cmos_sensor(0x3093, 0x00);
#endif
    
    
    OV16825_write_cmos_sensor(0x3094, 0x00);
    OV16825_write_cmos_sensor(0x3098, 0x03);//240MHz DAC
    OV16825_write_cmos_sensor(0x3099, 0x1e);//1c
    
    OV16825_write_cmos_sensor(0x30b3, 0x36);//648Mbps/lane, 3C:780M
    OV16825_write_cmos_sensor(0x30b4, 0x02);
    OV16825_write_cmos_sensor(0x30b5, 0x04);
    OV16825_write_cmos_sensor(0x30b6, 0x01);
	
    OV16825_write_cmos_sensor(0x3500, 0x00);
    OV16825_write_cmos_sensor(0x3501, 0x7c);
    OV16825_write_cmos_sensor(0x3502, 0x00);
	
    OV16825_write_cmos_sensor(0x3624, 0x00);
    OV16825_write_cmos_sensor(0x3680, 0xe0);
    OV16825_write_cmos_sensor(0x3702, 0xf3);//db
    OV16825_write_cmos_sensor(0x3704, 0x71);
    OV16825_write_cmos_sensor(0x3708, 0xe6);
    OV16825_write_cmos_sensor(0x3709, 0xc3);
    OV16825_write_cmos_sensor(0x371F, 0x0c);//0x18
    OV16825_write_cmos_sensor(0x3739, 0x30);
    //OV16825_write_cmos_sensor(0x373a, 0x51);
    OV16825_write_cmos_sensor(0x373C, 0x20);//38
    OV16825_write_cmos_sensor(0x3781, 0x0c);
    OV16825_write_cmos_sensor(0x3786, 0x16);
	
    OV16825_write_cmos_sensor(0x3796, 0x64);//78
    OV16825_write_cmos_sensor(0x3800, 0x00);
    OV16825_write_cmos_sensor(0x3801, 0x00);
    OV16825_write_cmos_sensor(0x3802, 0x00);
    OV16825_write_cmos_sensor(0x3803, 0x00);
    OV16825_write_cmos_sensor(0x3804, 0x0c);
    OV16825_write_cmos_sensor(0x3805, 0xcf);
    OV16825_write_cmos_sensor(0x3806, 0x09);
    OV16825_write_cmos_sensor(0x3807, 0x9f);
    OV16825_write_cmos_sensor(0x3808, 0x06);
    OV16825_write_cmos_sensor(0x3809, 0x60);
    OV16825_write_cmos_sensor(0x380a, 0x04);
    OV16825_write_cmos_sensor(0x380b, 0xC8);

	//HTS,VTS setting
#ifdef OV16825_2_LANE
    OV16825_write_cmos_sensor(0x380c, 0x0E);//for 30fps
    OV16825_write_cmos_sensor(0x380d, 0x18);
    OV16825_write_cmos_sensor(0x380e, 0x04);
    OV16825_write_cmos_sensor(0x380f, 0xE8);//fa
#else
    OV16825_write_cmos_sensor(0x380c, 0x0E);//for 30fps
    OV16825_write_cmos_sensor(0x380d, 0x18);
    OV16825_write_cmos_sensor(0x380e, 0x07);
    OV16825_write_cmos_sensor(0x380f, 0xcc);//fa
#endif
    OV16825_write_cmos_sensor(0x3814, 0x31);
    OV16825_write_cmos_sensor(0x3815, 0x31);
    OV16825_write_cmos_sensor(0x3820, 0x11);
    OV16825_write_cmos_sensor(0x3821, 0x0f);
	
    OV16825_write_cmos_sensor(0x3a04, 0x07);
    OV16825_write_cmos_sensor(0x3a05, 0xc8);
	
    OV16825_write_cmos_sensor(0x4001, 0x02);
    OV16825_write_cmos_sensor(0x4004, 0x04);
    //OV16825_write_cmos_sensor(0x4100, 0x04);
    //OV16825_write_cmos_sensor(0x4101, 0x04);
    //OV16825_write_cmos_sensor(0x4102, 0x04);
    //OV16825_write_cmos_sensor(0x4104, 0x04);
    //OV16825_write_cmos_sensor(0x4109, 0x04);

    OV16825_write_cmos_sensor(0x4005, 0x18);
    OV16825_write_cmos_sensor(0x404f, 0xa0);
	OV16825_write_cmos_sensor(0x5013, 0x04);
	OV16825_write_cmos_sensor(0x5045, 0x55);
	OV16825_write_cmos_sensor(0x5048, 0x0f);
    OV16825_write_cmos_sensor(0x0100, 0x01);
	

	mdelay(30);

	SENSORDB("OV16825_1632_1224_30fps_Mclk24M_setting end \n");
}

static void OV16825_3264_2448_4Lane_25fps_Mclk24M_setting(void)
{
/*
    ...
    V Total: 0x09da = 2522
*/
    OV16825_write_cmos_sensor(0x0100, 0x00); // software standby
    OV16825_write_cmos_sensor(0x3011, 0x41); // 4 Lane, MIPI enable
    OV16825_write_cmos_sensor(0x3015, 0x0a); // MIPI mode,
    
    OV16825_write_cmos_sensor(0x3090, 0x02); //228MHz SCLK 
    //OV16825_write_cmos_sensor(0x3091, 0x15); 
	OV16825_write_cmos_sensor(0x3091, 0x13);
    OV16825_write_cmos_sensor(0x3092, 0x00); 
    OV16825_write_cmos_sensor(0x3093, 0x00); 
    OV16825_write_cmos_sensor(0x3094, 0x00); 
    OV16825_write_cmos_sensor(0x3098, 0x02); //264MHz DAC 
    OV16825_write_cmos_sensor(0x3099, 0x16);
	
    OV16825_write_cmos_sensor(0x30b3, 0x36);//648Mbps/lane //3c
    OV16825_write_cmos_sensor(0x30b4, 0x02); 
    OV16825_write_cmos_sensor(0x30b5, 0x04); 
    OV16825_write_cmos_sensor(0x30b6, 0x01);

    //OV16825_write_cmos_sensor(0x4837, 0x0c);//780Mbps/lane 3c  //0a


    OV16825_write_cmos_sensor(0x3500, 0x00); 
    OV16825_write_cmos_sensor(0x3501, 0x9c); 
    OV16825_write_cmos_sensor(0x3502, 0x20); 
    OV16825_write_cmos_sensor(0x3624, 0x04);
    OV16825_write_cmos_sensor(0x3680, 0xB0);
    OV16825_write_cmos_sensor(0x3702, 0x6E);
    OV16825_write_cmos_sensor(0x3704, 0x55);
    OV16825_write_cmos_sensor(0x3708, 0xe4); 
    OV16825_write_cmos_sensor(0x3709, 0xc3); 
    OV16825_write_cmos_sensor(0x371F, 0x0D);
    OV16825_write_cmos_sensor(0x3739, 0x80);
    //OV16825_write_cmos_sensor(0x373a, 0x51);
    OV16825_write_cmos_sensor(0x373C, 0x24);
    OV16825_write_cmos_sensor(0x3781, 0xc8);
    OV16825_write_cmos_sensor(0x3786, 0x08);
    OV16825_write_cmos_sensor(0x3796, 0x43);
    OV16825_write_cmos_sensor(0x3800, 0x00); 
    OV16825_write_cmos_sensor(0x3801, 0x04); 
    OV16825_write_cmos_sensor(0x3802, 0x00); 
    OV16825_write_cmos_sensor(0x3803, 0x0c); 
    OV16825_write_cmos_sensor(0x3804, 0x0c); 
    OV16825_write_cmos_sensor(0x3805, 0xcb); 
    OV16825_write_cmos_sensor(0x3806, 0x09); 
    OV16825_write_cmos_sensor(0x3807, 0xa3); 
    OV16825_write_cmos_sensor(0x3808, 0x0c); 
    OV16825_write_cmos_sensor(0x3809, 0xc0); 
    OV16825_write_cmos_sensor(0x380a, 0x09); 
    OV16825_write_cmos_sensor(0x380b, 0x90); 
    OV16825_write_cmos_sensor(0x380c, 0x0e); 
    OV16825_write_cmos_sensor(0x380d, 0x18); 
    OV16825_write_cmos_sensor(0x380e, 0x09); //09 
    OV16825_write_cmos_sensor(0x380f, 0xda); //da
	
    OV16825_write_cmos_sensor(0x3814, 0x11); 
    OV16825_write_cmos_sensor(0x3815, 0x11); 
    OV16825_write_cmos_sensor(0x3820, 0x10); 
    OV16825_write_cmos_sensor(0x3821, 0x0e);
	
    OV16825_write_cmos_sensor(0x3a04, 0x09);
    OV16825_write_cmos_sensor(0x3a05, 0xcc);

    OV16825_write_cmos_sensor(0x4001, 0x06);
    OV16825_write_cmos_sensor(0x4004, 0x04); 
    //OV16825_write_cmos_sensor(0x4100, 0x22); 
    //OV16825_write_cmos_sensor(0x4101, 0x23); 
    //OV16825_write_cmos_sensor(0x4102, 0x44); 
    //OV16825_write_cmos_sensor(0x4104, 0x5c); 
    //OV16825_write_cmos_sensor(0x4109, 0x03);

    OV16825_write_cmos_sensor(0x4005, 0x1A);
	OV16825_write_cmos_sensor(0x5013, 0x00);
	OV16825_write_cmos_sensor(0x5045, 0x55);
	OV16825_write_cmos_sensor(0x5048, 0x10);

    OV16825_write_cmos_sensor(0x0100, 0x01); //wake up from software standby
	mdelay(30);

}


static void OV16825_3264_1836_4Lane_30fps_Mclk24M_setting(void)
{
/*
...
*/
    ...
    OV16825_write_cmos_sensor(0x3094, 0x00); 
    OV16825_write_cmos_sensor(0x3098, 0x03);//240MHz DAC 
    OV16825_write_cmos_sensor(0x3099, 0x1e); 
    ...
    OV16825_write_cmos_sensor(0x3624, 0x00);
    OV16825_write_cmos_sensor(0x3680, 0xe0);
    OV16825_write_cmos_sensor(0x3702, 0xF3); 
    OV16825_write_cmos_sensor(0x3704, 0x71);
    OV16825_write_cmos_sensor(0x3708, 0xe3);
    OV16825_write_cmos_sensor(0x3709, 0xc3); 
    OV16825_write_cmos_sensor(0x371F, 0x0C); 
    OV16825_write_cmos_sensor(0x3739, 0x30);
    //OV16825_write_cmos_sensor(0x373a, 0x51);
    OV16825_write_cmos_sensor(0x373C, 0x20); 
    OV16825_write_cmos_sensor(0x3781, 0x0c);
    OV16825_write_cmos_sensor(0x3786, 0x16);
    OV16825_write_cmos_sensor(0x3796, 0x64);
    OV16825_write_cmos_sensor(0x3800, 0x00); 
    OV16825_write_cmos_sensor(0x3801, 0x04);
    OV16825_write_cmos_sensor(0x3802, 0x01); 
    OV16825_write_cmos_sensor(0x3803, 0x38); 
    OV16825_write_cmos_sensor(0x3804, 0x0c); 
    OV16825_write_cmos_sensor(0x3805, 0xcb); 
    OV16825_write_cmos_sensor(0x3806, 0x08); 
    OV16825_write_cmos_sensor(0x3807, 0x6b); 
    OV16825_write_cmos_sensor(0x3808, 0x0c); 
    OV16825_write_cmos_sensor(0x3809, 0xc0); 
    OV16825_write_cmos_sensor(0x380a, 0x07); 
    OV16825_write_cmos_sensor(0x380b, 0x2c); 
    OV16825_write_cmos_sensor(0x380c, 0x0e);//for 30fps  
    OV16825_write_cmos_sensor(0x380d, 0x18); 
    OV16825_write_cmos_sensor(0x380e, 0x07); 
    OV16825_write_cmos_sensor(0x380f, 0xcc);
    ...
    OV16825_write_cmos_sensor(0x4001, 0x02);
    OV16825_write_cmos_sensor(0x4004, 0x08);
    //OV16825_write_cmos_sensor(0x4100, 0x04); 
    //OV16825_write_cmos_sensor(0x4101, 0x04); 
    //OV16825_write_cmos_sensor(0x4102, 0x04); 
    //OV16825_write_cmos_sensor(0x4104, 0x04);
...
static void OV16825_3264_2448_2Lane_15fps_Mclk24M_setting(void)
{
/*
...
*/
    ...
    OV16825_write_cmos_sensor(0x3500, 0x00); 
    OV16825_write_cmos_sensor(0x3501, 0x9a); 
    OV16825_write_cmos_sensor(0x3502, 0x60);
	
    OV16825_write_cmos_sensor(0x3011, 0x21); // 2 Lane, MIPI enable
    OV16825_write_cmos_sensor(0x3015, 0xca); // MIPI mode,
    
    OV16825_write_cmos_sensor(0x3090, 0x03); //228MHz SCLK 
    //OV16825_write_cmos_sensor(0x3091, 0x15); 
	OV16825_write_cmos_sensor(0x3091, 0x21);
    OV16825_write_cmos_sensor(0x3092, 0x00); 
    OV16825_write_cmos_sensor(0x3093, 0x02); 
    OV16825_write_cmos_sensor(0x3094, 0x00); 
    OV16825_write_cmos_sensor(0x3098, 0x03); //264MHz DAC 
    OV16825_write_cmos_sensor(0x3099, 0x1e);
    ...
    OV16825_write_cmos_sensor(0x380d, 0x18); 
    OV16825_write_cmos_sensor(0x380e, 0x09); //09 
    OV16825_write_cmos_sensor(0x380f, 0xd0); //da
    ...
    OV16825_write_cmos_sensor(0x3a04, 0x09);
    OV16825_write_cmos_sensor(0x3a05, 0xb0);
    ...
    OV16825_write_cmos_sensor(0x4005, 0x1a);
	OV16825_write_cmos_sensor(0x404f, 0xa0);
	OV16825_write_cmos_sensor(0x4837, 0x0c); 
;
	OV16825_write_cmos_sensor(0x5013, 0x00);
	OV16825_write_cmos_sensor(0x5045, 0x55);
	OV16825_write_cmos_sensor(0x5048, 0x10);
...
static void OV16825_1920_1080_2Lane_31fps_Mclk24M_setting(void)
{
/*
	
	//;;;;;;;;;;;;;Any modify please inform to OV FAE;;;;;;;;;;;;;;;	  
*/
	SENSORDB("OV16825_1920_1080_2lane_31fps_Mclk24M_setting start \n");
	...
	OV16825_write_cmos_sensor(0x3796, 0x64);//78
    OV16825_write_cmos_sensor(0x3800, 0x00);
    OV16825_write_cmos_sensor(0x3801, 0x0c);
    OV16825_write_cmos_sensor(0x3802, 0x01);
    //OV16825_write_cmos_sensor(0x3803, 0x3E);
	OV16825_write_cmos_sensor(0x3803, 0x40);
    OV16825_write_cmos_sensor(0x3804, 0x0c);
    OV16825_write_cmos_sensor(0x3805, 0xd3);
    OV16825_write_cmos_sensor(0x3806, 0x08);
    OV16825_write_cmos_sensor(0x3807, 0x73);
	//OV16825_write_cmos_sensor(0x3807, 0x71);
    ...
    OV16825_write_cmos_sensor(0x380d, 0x18);
    OV16825_write_cmos_sensor(0x380e, 0x07);
    OV16825_write_cmos_sensor(0x380f, 0x80);//fa
    ...
    OV16825_write_cmos_sensor(0x4005, 0x18); //BLC trigger when gain changed
    OV16825_write_cmos_sensor(0x404f, 0xa0);
	OV16825_write_cmos_sensor(0x4837, 0x0c);
	OV16825_write_cmos_sensor(0x5013, 0x04);
	OV16825_write_cmos_sensor(0x5045, 0x55);
	...
	SENSORDB("OV16825_1920_1080_2lane_31fps_Mclk24M_setting end \n");
}
static void OV16825_1920_1080_4Lane_30fps_Mclk26M_setting(void)
{
/*
...
*/
    ...
    OV16825_write_cmos_sensor(0x3011, 0x41);// 4 Lane, MIPI enable
    OV16825_write_cmos_sensor(0x3015, 0x0a);// MIPI mode,
    OV16825_write_cmos_sensor(0x3090, 0x02);// 204MHz SCLK 
    OV16825_write_cmos_sensor(0x3091, 0x11); 
    OV16825_write_cmos_sensor(0x3092, 0x00); 
    OV16825_write_cmos_sensor(0x3093, 0x00); 
    OV16825_write_cmos_sensor(0x3094, 0x00); 
    OV16825_write_cmos_sensor(0x3098, 0x03);//240MHz DAC 
    OV16825_write_cmos_sensor(0x3099, 0x1e); 
    OV16825_write_cmos_sensor(0x30b3, 0x2b);//516Mbps/lane
    OV16825_write_cmos_sensor(0x30b4, 0x02); 
    OV16825_write_cmos_sensor(0x30b5, 0x04); 
    OV16825_write_cmos_sensor(0x30b6, 0x01); 
    OV16825_write_cmos_sensor(0x3500, 0x00); 
    OV16825_write_cmos_sensor(0x3501, 0x75);      
    OV16825_write_cmos_sensor(0x3502, 0x80); 
    OV16825_write_cmos_sensor(0x3624, 0x04);
    OV16825_write_cmos_sensor(0x3680, 0xe0);
    OV16825_write_cmos_sensor(0x3702, 0xF3); 
    OV16825_write_cmos_sensor(0x3704, 0x71);
    ...
    OV16825_write_cmos_sensor(0x380d, 0x18); 
    OV16825_write_cmos_sensor(0x380e, 0x07); 
    OV16825_write_cmos_sensor(0x380f, 0x5c); 
    OV16825_write_cmos_sensor(0x3814, 0x11); 
    OV16825_write_cmos_sensor(0x3815, 0x11); 
    OV16825_write_cmos_sensor(0x3820, 0x10); 
    OV16825_write_cmos_sensor(0x3821, 0x0e); 
...
static void OV16825MIPI_Sensor_Init(void)
{
	...
	*/
	...
	OV16825_write_cmos_sensor(0x4006, 0x04);
	OV16825_write_cmos_sensor(0x4007, 0x04);
	OV16825_write_cmos_sensor(0x0100, 0x01);
        ...
        MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    OV16825_Set_Dummy(dummy_pixel, dummy_line);
