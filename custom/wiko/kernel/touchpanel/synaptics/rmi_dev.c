...
atomic_t debug_flag=ATOMIC_INIT(0);
#endif
		...
		struct device_attribute *attr, char *buf)
{
	...
	return sprintf(buf, "%d %d\n", CUST_EINT_TOUCH_PANEL_TYPE, attn);	
}
