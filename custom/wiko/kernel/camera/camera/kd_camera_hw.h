...
#ifndef GPIO_CAMERA_LDO_A280V_EN_PIN 
#define GPIO_CAMERA_LDO_A280V_EN_PIN  (GPIO114 | 0x80000000)
#endif

#ifndef GPIO_CAMERA_LDO_D105V_EN_PIN 
#define GPIO_CAMERA_LDO_D105V_EN_PIN  (GPIO46 | 0x80000000)
#endif 
