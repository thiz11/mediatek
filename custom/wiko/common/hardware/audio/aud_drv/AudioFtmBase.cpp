...
AudioFtmBase *AudioFtmBase::createAudioFtmInstance()
{
   ...
   mAudioFtm = AudioFtm::getInstance();
    return mAudioFtm;
}
...
int AudioFtmBase::Audio_FM_I2S_Play(int enable_flag) { return mAudioFtm->Audio_FM_I2S_Play(enable_flag?true:false);}// { return true; }
