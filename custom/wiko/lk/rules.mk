...
INCLUDES += -I$(LOCAL_DIR)/lcm/inc \
            -I$(LOCAL_DIR)/inc \
            -I$(ANDROID_TOP)/$(MTK_ROOT_OUT)/PTGEN/lk/inc \
            -I$(ANDROID_TOP)/$(MTK_ROOT_OUT)/PTGEN/common \
	    -I$(ANDROID_TOP)/$(MTK_ROOT_OUT)/NANDGEN/common

# object files list
# sample

OBJS += \
	$(patsubst %.c,%.o,$(call wildcard2, $(LOCAL_DIR)/*.c, $(LOCAL_DIR)/lcm/*.c)) \
