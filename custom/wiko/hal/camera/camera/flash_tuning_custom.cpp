...
FLASH_PROJECT_PARA& cust_getFlashProjectPara(int aeMode, NVRAM_CAMERA_STROBE_STRUCT* nvrame)
{
	...
	para.coolTimeOutPara.tabId[2]=5;
	...
	para.coolTimeOutPara.timOutMs[2]=800;
	...
	para.flashReflectanceWeight = 255;
