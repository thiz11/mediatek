...
public:     ////    Set Index
    ...
    inline bool setIdx_SL2(UINT8 const idx)        { return setIdx(m_rIdx.SL2, idx, NUM_SL2); }
...
public:     ////    Get Index
    ...
    inline UINT8 getIdx_SL2()       const { return m_rIdx.SL2; }
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    inline ISP_NVRAM_SL2_T&         getSL2(UINT8 const idx) { return m_rRegs.SL2[idx]; }
