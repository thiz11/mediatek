...
typedef union {
    enum { MASK     = 0x00100301 };
    enum { DEFAULT  = 0x00100000 };
...
typedef struct {
        MUINT32 SL2_CENTER_X              : 13;
        MUINT32 rsv_13                    : 3;
        MUINT32 SL2_CENTER_Y              : 12;
        MUINT32 rsv_28                    : 4;
} ISP_CAM_SL2_CEN_T;

typedef union {
    enum { MASK     = 0x0FFF1FFF };
    enum { DEFAULT  = 0x00000000 };
...
typedef struct {
        ...
        MUINT32 USM_OVER_CLIP_STR         : 3;
        MUINT32 USM_REDUCE_SINGLEDOT      : 1;
        MUINT32 USM_SINGLEDOT_WF          : 3;
        MUINT32 USM_SINGLEDOT_TH          : 8;
        MUINT32 USM_CLIP                  : 8;
        MUINT32 rsv_24                    : 8;
...
typedef struct {
        MUINT32 AWB_WIN_ORG_X            : 13;
        MUINT32 rsv_13                   : 3;
        MUINT32 AWB_WIN_ORG_Y            : 13;
        MUINT32 rsv_29                   : 3;
...
typedef struct {
        MUINT32 AWB_WIN_SIZE_X            : 13;
        MUINT32 rsv_13                    : 3;
        MUINT32 AWB_WIN_SIZE_Y            : 13;
        MUINT32 rsv_29                    : 3;
...
typedef struct {
        MUINT32 AWB_WIN_PIT_X             : 13;
        MUINT32 rsv_13                    : 3;
        MUINT32 AWB_WIN_PIT_Y             : 13;
        MUINT32 rsv_29                    : 3;
...
typedef struct {
        MUINT32 AWB_WIN_NUM_X             : 8;
        MUINT32 rsv_8                     : 8;
        MUINT32 AWB_WIN_NUM_Y             : 8;
        MUINT32 rsv_24                    : 8;
...
typedef struct {
        MUINT32 RAWPREGAIN1_R             : 13;
        MUINT32 rsv_13                    : 3;
        MUINT32 RAWPREGAIN1_G             : 13;
        MUINT32 rsv_29                    : 3;
...
typedef struct {
        MUINT32 RAWLIMIT1_R               : 12;
        MUINT32 rsv_12                    : 4;
        MUINT32 RAWLIMIT1_G               : 12;
        MUINT32 rsv_28                    : 4;
