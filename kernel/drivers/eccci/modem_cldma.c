...
static struct ccci_port md_cd_ports_normal[] = {
	...
	{CCCI_DUMMY_CH, CCCI_DUMMY_CH, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 1, "eemcs_muxrp", },
	{CCCI_DUMMY_CH, CCCI_DUMMY_CH, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 2, "eemcs_ril", },
		
	{CCCI_IMSV_UL, CCCI_IMSV_DL, 6, 6, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 6, "eemcs_imsv", },
	{CCCI_IMSC_UL, CCCI_IMSC_DL, 6, 6, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 7, "eemcs_imsc", },
	{CCCI_IMSA_UL, CCCI_IMSA_DL, 6, 6, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 8, "eemcs_imsa", },
	{CCCI_IMSDC_UL, CCCI_IMSDC_DL, 6, 6, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 9, "eemcs_imsdc", },
		
	{CCCI_UART1_TX, CCCI_UART1_RX, 1, 1, 1, 1, 0, &char_port_ops, MD_CD_MAJOR, 10, "eemcs_md_log_ctrl", },
	{CCCI_UART2_TX, CCCI_UART2_RX, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 11, "eemcs_mux", },
	
	{CCCI_PCM_TX, CCCI_PCM_RX, 0, 0, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 12, "eemcs_aud", },
	{CCCI_FS_TX, CCCI_FS_RX, 1, 1, 0xFF, 0xFF, 4, &char_port_ops, MD_CD_MAJOR, 13, "eemcs_fs", },
	{CCCI_MD_LOG_TX, CCCI_MD_LOG_RX, 1, 2, 2, 8, 0, &char_port_ops, MD_CD_MAJOR, 14, "eemcs_md_log", },
	{CCCI_RPC_TX, CCCI_RPC_RX, 1, 1, 0xFF, 0xFF, 0, &kernel_port_ops, 0, 0, "eemcs_rpc", },
	
	{CCCI_IPC_UART_TX, CCCI_IPC_UART_RX, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 15, "eemcs_ipc_uart", },
	{CCCI_IT_TX, CCCI_IT_RX, 0, 0, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 16, "eemcs_it", },
	...
	{CCCI_DUMMY_CH, CCCI_DUMMY_CH, 0xFF, 0xFF, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 1, "ccci_ioctl0", },
	{CCCI_DUMMY_CH, CCCI_DUMMY_CH, 0xFF, 0xFF, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 2, "ccci_ioctl1", },
	{CCCI_DUMMY_CH, CCCI_DUMMY_CH, 0xFF, 0xFF, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 3, "ccci_ioctl2", },
	{CCCI_DUMMY_CH, CCCI_DUMMY_CH, 0xFF, 0xFF, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 4, "ccci_ioctl3", },
	{CCCI_DUMMY_CH, CCCI_DUMMY_CH, 0xFF, 0xFF, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 5, "ccci_ioctl4", },
		
	{CCCI_IMSV_UL, CCCI_IMSV_DL, 6, 6, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 6, "ccci_imsv", },
	{CCCI_IMSC_UL, CCCI_IMSC_DL, 6, 6, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 7, "ccci_imsc", },
	{CCCI_IMSA_UL, CCCI_IMSA_DL, 6, 6, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 8, "ccci_imsa", },
	{CCCI_IMSDC_UL, CCCI_IMSDC_DL, 6, 6, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 9, "ccci_imsdc", },
		
	{CCCI_UART1_TX, CCCI_UART1_RX, 1, 1, 1, 1, 0, &char_port_ops, MD_CD_MAJOR, 10, "ccci_md_log_ctrl", },
	{CCCI_UART2_TX, CCCI_UART2_RX, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 11, "ttyC0", },
	
	{CCCI_PCM_TX, CCCI_PCM_RX, 0, 0, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 12, "ccci_aud", },
	{CCCI_FS_TX, CCCI_FS_RX, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 13, "ccci_fs", },
	{CCCI_MD_LOG_TX, CCCI_MD_LOG_RX, 1, 2, 2, 8, 0, &char_port_ops, MD_CD_MAJOR, 14, "ttyC1", },
	{CCCI_RPC_TX, CCCI_RPC_RX, 1, 1, 0xFF, 0xFF, 0, &kernel_port_ops, 0, 0, "ccci_rpc", },
	
	{CCCI_IPC_UART_TX, CCCI_IPC_UART_RX, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 15, "ttyC2", },
	{CCCI_ICUSB_TX, CCCI_ICUSB_RX, 1, 1, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 16, "ccci_ttyC3", },
	{CCCI_IT_TX, CCCI_IT_RX, 0, 0, 0xFF, 0xFF, 0, &char_port_ops, MD_CD_MAJOR, 17, "ccci_it", },
...
static int cldma_rx_collect(struct md_cd_queue *queue, int budget)
{
	...
	queue->tr_done = req;
	// resume Rx queue, Rx only stops when it consumed all HWO buffer slots
	if(count==RING_BUFF_SIZE) {
...
static void cldma_tx_done(struct work_struct *work)
{
	...
	struct ccci_request *req = queue->tr_done;
	struct cldma_tgpd *tgpd = (struct cldma_tgpd *)req->gpd;
	int count = 0;
	
	while(1) {
		spin_lock(&queue->ring_lock);
		if(!((tgpd->gpd_flags&0x1) == 0 && req->skb)) {
			spin_unlock(&queue->ring_lock);
			break;
		}
		// update counter
		queue->free_slot++;
...
static irqreturn_t cldma_isr(int irq, void *data)
{
	...
	// DO NOT touch Tx or Rx queue's GPD in ISR, as we use spin_lock but not spin_lock_irqsave
...
#if defined(MT6290) || defined(ROME)
	cldma_sw_init(md);
#endif
	// init queue
	for(i=0; i<QUEUE_LEN(md_ctrl->txq); i++) {
...
static int md_cd_start(struct ccci_modem *md)
{
	...
	// 5. start timer
	mod_timer(&md->bootup_timer, jiffies+15*HZ);
	// 6. let modem go
	md_cd_let_md_go(md);
	// 7. start CLDMA
#if defined(MT6290) || defined(ROME)
...
static int md_cd_stop(struct ccci_modem *md)
{
	CCCI_INF_MSG(md->index, TAG, "CLDMA modem is power off\n");
	md_cd_power_off(md);
...
retry:
	...
	if(queue->free_slot > 0) {
		...
		spin_unlock(&queue->ring_lock); // TX_DONE will check this flag to recycle TGPD
	} else {
		spin_unlock(&queue->ring_lock);
...
static int md_cd_send_runtime_data(struct ccci_modem *md)
{
	...
	CCCI_INF_MSG(md->index, TAG, "random_seed=%x,misc_info.feature_2_val[0]=%x,d=%d\n", random_seed, runtime->feature_2_val[0], random_seed);
...
static irqreturn_t md_cd_ccif_work(struct work_struct *work)
{
	struct md_cd_ctrl *md_ctrl = container_of(work, struct md_cd_ctrl, ccif_work);
	struct ccci_modem *md = container_of(md_ctrl, struct ccci_modem, private_data);
...
static irqreturn_t md_cd_ccif_isr(int irq, void *data)
{
	struct ccci_modem *md = (struct ccci_modem *)data;
	struct md_cd_ctrl *md_ctrl = (struct md_cd_ctrl *)md->private_data;
	// we use workqueue here due to not using spin_lock_irqsave when clear Tx queue
...
#else
	count = snprintf(buf, 128, "no CLDMA hardware\n");
#endif
	return count;
}
