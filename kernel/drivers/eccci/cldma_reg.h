...
#define cldma_read8(b, a)				ioread8((b)+(a))
#else
#define cldma_write32(b, a, v)			(0)
#define cldma_write16(b, a, v)			(0)
#define cldma_write8(b, a, v)			(0)

#define cldma_read32(b, a)				(0)
#define cldma_read16(b, a)				(0)
#define cldma_read8(b, a)				(0)
#endif
#endif
