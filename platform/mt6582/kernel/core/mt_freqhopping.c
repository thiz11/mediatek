...
static const struct freqhopping_ssc mt_ssc_mempll_setting[MT_SSC_NR_PREDEFINE_SETTING]= {
	{0,0,0,0,0,0},//Means disable
	{0,0xFF,0xFF,0xFF,0xFF,0xFF},//Means User-Define
	{266000 ,2 ,7 ,0, 4, 0x0014030c},//266MHz , 0.27us, 0.007812500 , 0 ~ -8%   range:0x00131A2D ~ 0x1256AD(0x00131A2D-(0x061C x 32))
	{200000 ,2 ,7 ,0, 4, 0x000f04b0},//200MHz , 0.27us, 0.007812500, 0 ~ -8%  
	{0,0,0,0,0,0} //EOF
};
